...
namespace Lab
{
    ...
    public class Assets
    {
        ...
        public MyModel CreateTexturedCube(String texturePath, Vector3 size)
        {
            ...
            // TASK 4
            // Specify collision radius as the average of the 3 sizes
            // N.B. There are many to calculate the collision radius, you may prefer to use the maximum value
            // of the sizes, for example, or the distance from the centre of the cube to the corner.
            // You can also use more sophisticated bounding shapes, such as rectangular prisms, although this 
